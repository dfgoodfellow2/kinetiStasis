export const store = $state({ user: null, currentPage: 'login', units: 'metric', sleepQualityMax: 10, editData: null })
...
export function setEditData(data) { store.editData = data }
export function clearEditData() { store.editData = null }
